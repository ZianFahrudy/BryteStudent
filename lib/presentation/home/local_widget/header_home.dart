...
class _HeaderHomeState extends State<HeaderHome> {
    ...
    return BlocBuilder<SummaryBloc, SummaryState>(
      builder: (context, state) {
        if (state is ClassSummaryStudentSuccess) {
          ...
          return _buildSummmarySuccess(today, conditionWidget, state);
        } else if (state is ClassSummaryStudentLoading) {
          return _buildSummaryLoading(context);
        } else if (state is ClassSummaryStudentFailure) {
          return _buildSummaryFailure(context);
        } else {
  ...
  SizedBox _buildSummaryFailure(BuildContext context) {
    return SizedBox(
  ...
  SizedBox _buildSummaryLoading(BuildContext context) {
    return SizedBox(
      height: MediaQuery.of(context).size.height / 4,
      child: const Center(
        child: CircularProgressIndicator(),
  ...
  Column _buildSummmarySuccess(
      DateTime today,
      Widget Function(ClassSummaryStudentSuccess state) conditionWidget,
      ClassSummaryStudentSuccess state) {
    return Column(
