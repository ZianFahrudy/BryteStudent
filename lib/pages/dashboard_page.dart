...
// import 'package:bryte/core/interceptor/retry_interceptor.dart';
...
// import '../core/interceptor/dio_connectivity_request_retry.dart';
...
//           //   state.response.data[0].assignAttempt = true;
//           //   state.response.data[1].assignAttempt = false;
//           //   for (var i = 0; i < state.response.data.length; i++) {
//           //     if (state.response.data[i].assignAttempt == false) {
//           //       listNotAssign.add(state.response.data[i]);
//           //       log(listNotAssign.length.toString());
//           //     }
//           //   }
//           // }
//         },
